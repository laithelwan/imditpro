...
في هذا المشروع كنت مسؤولًا عن تنسيق الواجهة الأمامية (CSS)، مع التركيز على صفحة التعديل (Edit Page)، بالإضافة إلى تنفيذ نظام تغيير الثيم بين الوضع الليلي (Dark Mode) والوضع النهاري (Light Mode) باستخدام CSS و JavaScript
ملاحظة:
